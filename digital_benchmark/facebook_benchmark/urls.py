...
urlpatterns = [
    ...
    path('load_facebook_pages/', views.LoadFacebookPages.as_view(), name='load_facebook_pages'),
    path('fetch_facebook_profile/<str:user_access_token>/', views.FetchFacebookProfile.as_view(), name='fetch_facebook_profile'),
    path('load_facebook_page_data/<int:page_id>/', views.LoadFacebookPageData.as_view(), name='load_facebook_page_data'),
