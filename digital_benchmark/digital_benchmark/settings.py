...
FACEBOOK_DEFAULT_FIELDS_FOR_FEED = ['backdated_time','comments','created_time','id','is_eligible_for_promotion','is_expired','is_hidden','is_instagram_eligible','is_popular','is_published','message','promotion_status','reactions','scheduled_publish_time','shares','story','timeline_visibility','updated_time']
FACEBOOK_DEFAULT_FIELDS_FOR_POST = ['backdated_time','comments','created_time','id','is_eligible_for_promotion','is_expired','is_hidden','is_instagram_eligible','is_popular','is_published','message','promotion_status','reactions','scheduled_publish_time','shares','story','timeline_visibility','updated_time']
